...
def test_pbp_split_strategy_not_learnt_prior(dataset_name, dataset_path, expected_lengths):
    ...
    strategy.split(dataset_loader=dataset_loader,
    ...
    intersections = get_intersections(strategy.val_loader.sampler.indices,
...
def test_pbp_split_strategy_learnt_self_certified_prior(dataset_name, dataset_path, expected_lengths):
    factory = DatasetLoaderFactory()
    dataset_loader = factory.create(dataset_name, dataset_path)
...
def test_pbp_split_strategy_learnt_not_self_certified_prior(dataset_name, dataset_path, expected_lengths):
    factory = DatasetLoaderFactory()
    dataset_loader = factory.create(dataset_name, dataset_path)
