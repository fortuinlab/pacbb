...
class MetricFactory(AbstractFactory[Callable]):
    def __init__(self) -> None:
        ...
        self.register_creator(
            ...
            lambda o, t, pmin: torchmetrics.functional.accuracy(
                o, t, task="multiclass", num_classes=10, average="micro"
            ),
        )
        self.register_creator(
            "f1_micro_metric",
            lambda o, t, pmin: torchmetrics.functional.f1_score(
                o, t, task="multiclass", num_classes=10, average="micro"
            ),
        )
        self.register_creator(
            ...
            lambda o, t, pmin: torchmetrics.functional.accuracy(
                o, t, task="multiclass", num_classes=10, average="macro"
            ),
        )
        self.register_creator(
            "f1_macro_metric",
